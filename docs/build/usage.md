...
Per the [input documentation](../reference/inputs.md#automatically-derived-formats), `buf build` can deduce the output format by the file extension. For example,
