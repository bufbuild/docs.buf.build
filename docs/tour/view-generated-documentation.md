...
page to the generated docs (i.e. replace `acme` with your `$BUF_USER` in this link).
...
packages are available as links, as [`google.type`](https://buf.build/googleapis/googleapis/docs/main/google.type)
is a dependency of your module. Click on the `pet.v1` link to navigate to its package
